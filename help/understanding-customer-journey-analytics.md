...
landing-page-description: 了解如何对任何Experience Platform数据集进行多渠道分析。
...
Adobe Customer Journey Analytics(CJA)是一项基于Adobe Experience Platform构建的应用程序服务。 它将称为 Analysis Workspace 的丰富分析工具引入平台中，以便您对所有平台数据集进行多渠道分析。
