...
+ Customer Journey Analytics 基础知识 {#cja-basics}
  ...
  + [为什么选择 CJA？ CJA与Adobe Analytics的战略回顾](cja-basics/why-cja-modernize-customer-analytics.md)
  + [Customer Journey Analytics 简介](cja-basics/understanding-customer-journey-analytics.md)
  + [Analytics到CJA：新术语及其映射方式](cja-basics/new-terms-and-concepts-in-cja.md)
  + [Customer Journey Analytics 登陆页面](cja-basics/customer-journey-analytics-landing-page.md)
  + [使用 AI 助手](cja-basics/use-ai-assistant.md)
...
+ 数据视图 {#data-views}
  ...
  + [创建汇总级数据源](data-views/create-summary-level-data-sources.md)
  ...
  + 派生字段{#derived-fields}
    + [创建派生字段](data-views/derived-fields/derived-fields-in-cja.md)
    + [使用数学函数](data-views/derived-fields/use-the-math-function-in-derived-fields.md)
    + [使用 Next 或 Previous 函数](data-views/derived-fields/use-the-next-previous-function-in-derived-fields.md)
    + [自定义事件深度](data-views/derived-fields/customize-event-depth-in-derived-fields.md)
    + [使用类型转换](data-views/derived-fields/use-typecasting-in-derived-fields.md)
    + [使用日期数学计算事件之间的时间](data-views/derived-fields/use-date-math-to-calculate-time-between-events.md)
+ Data Insights 代理 {#data-insights-agent}
  ...
  + [使用 Data Insights 代理](data-insights-agent/use-the-data-insights-agent.md)
  + [与Microsoft 365 Copilot集成](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  ...
  + 面板 {#panels}
    ...
    + [使用快速洞察面板](analysis-workspace/panels/use-the-quick-insights-panel.md)
  + 模板 {#templates}
  ...
  + 可视化图表 {#visualizations}
    ...
    + [Dimension-Graph实时链接](analysis-workspace/visualizations/dimension-graph-live-linking.md)
    + [创建智能题注](analysis-workspace/visualizations/intelligent-captions.md)
    + [表和可视化图表数据源设置](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [自定义可视化图例](analysis-workspace/visualizations/cja-customize-visualization-legends.md)
    + [设置可视化图表的粒度](analysis-workspace/visualizations/cja-set-granularity-for-visualizations.md)
...
+ 引导式分析 {#guided-analysis}
  + [在 Workspace 中使用引导式分析](guided-analysis/guided-analysis-in-workspace.md)
  ...
  + [时间线](guided-analysis/timeline.md)
...
+ 组件 {#components}
  + 区段 {#filters}
    ...
    + [使用区段作为维度](components/filters/use-filters-as-dimensions.md)
    + [从区段创建受众](components/filters/create-audiences-from-segments.md)
    ...
    + [使用子事件的对象级别分段](components/filters/object-level-segmentation-using-sub-events.md)
  + [实时报告](components/real-time-reporting.md)
  + 维度 {#dimensions}
...
+ Content Analytics {#content-analytics}
  ...
  + [报告](content-analytics/reporting.md)
+ 仪表板（记分卡） {#dashboards}
...
+ 导出 {#exporting}
  ...
  + [管理全表导出](exporting/manage-full-table-exports.md)
...
+ 报告活动管理器 {#reporting-activity-manager}
  + [访问报告活动管理器](reporting-activity-manager/use-the-reporting-activity-manager.md)
+ Experience Platform 集成 {#experience-platform-integration}
  + [Adobe Journey Optimizer 的增强报告](experience-platform-integration/enhanced-reporting-for-adobe-journey-optimizer.md)
+ 用例 {#use-cases}
  + 人工智能 {#ai}
    + [跟踪和分析 AI 流量](use-cases/ai/track-and-analyze-ai-traffic.md)
    + [使用Data Engineering Agent验证数据集质量](use-cases/ai/validate-dataset-quality-data-engineering-agent.md)
...
+ [适用于Customer Journey Analytics的Data Mirror](data-mirror/cja-data-mirror-sync-external-platforms.md)
