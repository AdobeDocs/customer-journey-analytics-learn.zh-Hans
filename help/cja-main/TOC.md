...
+ 连接 {#connections}
   ...
   + [CJA中的连接详细信息体验](connections/connections-details-experience-in-cja.md)
...
+ 数据视图 {#data-views}
   ...
   + [配置数据视图中的“无值”选项](data-views/configure-no-value-options-in-data-views.md)
...
+ 组件 {#components}
   + 过滤器（分段） {#filters}
      + [筛选器简介](components/filters/introduction-to-filters-in-cja.md)
      + [创建跨渠道筛选器](components/filters/creating-cross-channel-filters-in-customer-journey-analytics.md)
      + [将 Adobe Analytics 区段移动到 Customer Journey Analytics](components/filters/moving-adobe-analytics-segments-to-customer-journey-analytics.md)
   + 计算指标 {#calc-metrics}
