---
title: 将 CJA 与 Marketo 集成以获取 B2B 洞察
description: 探索Customer Journey Analytics如何与Marketo集成以增强B2B营销见解，并重点关注收入和促销活动有效性。
feature: Basics
role: User
level: Intermediate
...
# 将Customer Journey Analytics与Marketo集成，以获取B2B见解
